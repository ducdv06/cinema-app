...
const styles = StyleSheet.create({
  ...
  circleBtn: { width: 54, height: 54, borderRadius: 999, backgroundColor: "#252836", justifyContent: "center", alignItems: "center", marginHorizontal: 6 },
  storyContainer: { marginTop: 32, paddingHorizontal: 24 },
  sectionTitle: { color: "#FFF", fontFamily: "MontserratSemiBold", fontSize: 16, marginBottom: 8 },
  ...
  castRow: { paddingLeft: 24, paddingRight: 8, gap: 12, marginTop: 16 },
  castItem: { flexDirection: "row", alignItems: "center", gap: 8 },
  castAvatar: { width: 40, height: 40, borderRadius: 999 },
  castInfo: { justifyContent: "center" },
  castName: { color: "#FFF", fontFamily: "MontserratSemiBold", fontSize: 14 },
  castRole: { color: "#92929D", fontFamily: "MontserratMedium", fontSize: 10 },
  ...
  thumbnailWrapper: { width: 121, height: 83, borderRadius: 8, overflow: "hidden", position: "relative" },
  episodeThumbnail: { width: "100%", height: "100%", resizeMode: "cover" },
  playBtn: { position: "absolute", top: "50%", left: "50%", transform: [{ translateX: -20 }, { translateY: -20 }], width: 40, height: 40, borderRadius: 999, backgroundColor: "rgba(255,255,255,0.2)", justifyContent: "center", alignItems: "center" },
  episodeInfo: { flex: 1, marginLeft: 16 },
  premiumBadge: { backgroundColor: "#FF8700", borderRadius: 6, paddingHorizontal: 8, paddingVertical: 4, alignSelf: "flex-start", marginBottom: 4 },
  premiumText: { color: "#FFF", fontFamily: "MontserratMedium", fontSize: 10 },
  durationText: { color: "#92929D", fontFamily: "MontserratMedium", fontSize: 12, marginBottom: 4 },
  episodeTitle: { color: "#FFF", fontFamily: "MontserratSemiBold", fontSize: 14 },
  downloadBtn: { width: 52, height: 52, borderRadius: 999, backgroundColor: "#1F1D2B", justifyContent: "center", alignItems: "center" },
  episodeDesc: { marginTop: 11, color: "#EBEBEF", fontFamily: "MontserratRegular", fontSize: 14, lineHeight: 22.4 },
  ...
  closeBtn: { position: "absolute", top: 16, right: 16, width: 32, height: 32, borderRadius: 10, backgroundColor: "rgba(31,29,43,0.8)", justifyContent: "center", alignItems: "center" },
